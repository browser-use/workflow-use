...
class VariableExtractor:
    ...
    def _process_step_markers(
        self, step: WorkflowStep, extracted_inputs: Dict[str, WorkflowInputSchemaDefinition]
    ) -> None:
    ...
    async def suggest_variables(
        ...
        messages = [
            ...
            UserMessage(content="Please analyze this workflow and suggest variables.")
        ]
